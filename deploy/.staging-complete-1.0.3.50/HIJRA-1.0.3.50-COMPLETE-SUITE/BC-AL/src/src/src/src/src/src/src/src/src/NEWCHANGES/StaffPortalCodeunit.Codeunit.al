codeunit 50049 "Staff Portal Codeunit"
{
    ...
    begin
        ...
        if action = 'create' then begin
            ...
            // Re-stamp after Validate so Days Applied is never wiped to blank/0.5.
            if isHalfDayLeave then begin
                TbHRLeaveRequisition."Select Whether Half Day" :=
                    TbHRLeaveRequisition."Select Whether Half Day"::"Half Day Morning";
                TbHRLeaveRequisition."Days Applied" := 0.5;
            ...
            // UAT 25/07/2026: portal create must run Days Applied validation so balance
            // fields populate and days/dates persist on the BC card (LV00125 showed blank).
            // Requires HRLeaveApplication.Table.al PATCH 4 (calendar filter + card balance).
    ...
    begin
        ...
        if action = 'create' then begin
            ...
            TbImprestRequisitionLines."No of Days" := noOfDays;
