  ...
  return (
    <MultiStepRequestPage
      ...
      detailFields={[
        ...
        { label: 'Travel Start Date', paths: ['payload.TravelDate', 'payload.Travel_Date'], format: 'date' },
        ...
        },
        {
          ...
          paths: ['payload.RemainingUnsettledAmount', 'payload.Balance', 'payload.BalanceLessThisEntry', 'payload.OutstandingBalance'],
          format: 'currency',
        },
