...
function MaintenanceWorkflowActions({
  ...
  if (!assignedTechnician && !receivedDate && !canAssign && !canConfirm) return null
  ...
  return (
    <RequestFormPage
      ...
      detailFields={[
        ...
        { label: 'Assigned Technician', paths: ['payload.AssignedTechnicianName', 'payload.Assigned_Technician_Name', 'payload.AssignedTechnician', 'payload.Assigned_Technician'] },
        { label: 'Receipt Confirmed On', paths: ['payload.FAReceivedDate', 'payload.FA_Received_Date'], format: 'date' },
        { label: 'Receipt Remarks', paths: ['payload.ReceiptRemarks', 'payload.Receipt_Remarks'] },
