...
export function PurchaseRequisition() {
  ...
  return (
    <MultiStepRequestPage
      ...
      description="Create the purchase header, then add item lines with location and reason. Business Central permits approval only for items included in the finalized budget for the selected department."
      module={module}
