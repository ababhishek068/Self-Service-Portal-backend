param(
    ...
    [string]$MinimumVersion = '1.0.5.77'
)
...
$regularFiles = @(
    'Query\GatePass.Query.al',
    'Query\GatePassAssetTransfers.Query.al',
    'Query\GatePassTransferShipments.Query.al',
    'Query\ImprestHeaders.Query.al',
    'Query\ImprestLines2.Query.al',
    'Query\ReceiptPaymentTypes.Query.al',
    ...
    'staffPortal\query\HrEmployee.Query.al',
    ...
    'staffPortal\query\QyGatePassReturns.Query.al',
...
Assert-Object-Count 'query' 50123 1
...
Assert-Object-Count 'query' 52171 1
