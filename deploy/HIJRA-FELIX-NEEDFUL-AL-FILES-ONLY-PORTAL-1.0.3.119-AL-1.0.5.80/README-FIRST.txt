HIJRA SSP — NEEDFUL AL FILES ONLY — PORTAL 1.0.3.119 / AL 1.0.5.80
====================================================================

IMPORTANT
---------
Portal v1.0.3.119 contains the UI/backend fixes. The following BC objects in
...
Portal v1.0.3.119 also presents Store Requisition according to the complete
...
Portal v1.0.3.119 fixes Facility list values without requiring another AL
...
Portal v1.0.3.119 also corrects Maintenance Request detail presentation. It
...
1.0.5.80 AL merge and normal app upgrade before portal 1.0.3.119 is tested.

Portal v1.0.3.119 corrects the browser timeout for Business Central-backed
...
Portal v1.0.3.119 also fixes the user-specific Staff Claim creation error where
...
Portal v1.0.3.119 corrects Leave Approval Detail without another AL change.
...
Portal v1.0.3.119 also keeps the employee-side Approval Workflow visible for
...
Portal v1.0.3.119 removes Location / Coordinates, Sign-in Location and Sign-out
...
Portal v1.0.3.119 fixes Training Need Assessment course selection. The
...
Portal v1.0.3.119 / AL v1.0.5.80 fixes the Imprest ERP daily-rate identity
...
Portal v1.0.3.119 cleans the Imprest Surrender selection preview. Fields that
...
Portal v1.0.3.119 makes Staff Claim line columns follow the selected claim
...
Portal v1.0.3.119 reduces the Store Requisition line table to the employee's
