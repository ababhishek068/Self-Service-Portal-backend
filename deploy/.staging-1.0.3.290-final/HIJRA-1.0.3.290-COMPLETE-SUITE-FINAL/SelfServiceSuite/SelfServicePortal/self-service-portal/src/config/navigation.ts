...
export const navigationMenu: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Petty Cash Settlement', path: '/finance/petty-cash', icon: Banknote },
      { label: 'Petty Cash Request', path: '/finance/petty-cash-replenishment', icon: ReceiptText },
    ],
  },
  {
    label: 'Facilities',
    ...
    children: [
      {
        ...
        children: [
          ...
          { label: 'Maintained Asset Gate Pass', path: '/facility/gate-pass/maintenance', icon: Wrench },
          {
            label: 'Gate Pass Log',
      ...
      { label: 'Individual Procurement Budget', path: '/facility/procurement-plan', icon: ClipboardList },
