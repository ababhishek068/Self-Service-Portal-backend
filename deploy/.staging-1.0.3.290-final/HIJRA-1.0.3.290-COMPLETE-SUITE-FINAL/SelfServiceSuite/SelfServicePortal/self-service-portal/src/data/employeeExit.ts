import { ArrowRightLeft, UserMinus, type LucideIcon } from 'lucide-react'
...
export const EMPLOYEE_EXIT_FIELDS: Record<EmployeeExitRequestType, EmployeeExitFieldConfig[]> = {
  ...
  resignation: [
    ...
    { name: 'leavingReasons', label: 'Reason for leaving Hijra Bank (select all that apply)', type: 'multiselect', options: reasonOptions },
    ...
    { name: 'wouldReturn', label: 'Would you consider returning to Hijra Bank in the future?', type: 'select', placeholder: 'Select an answer', options: [{ label: 'Yes', value: 'Yes' }, { label: 'No', value: 'No' }, { label: 'Maybe', value: 'Maybe' }] },
    { name: 'mostSatisfying', label: 'What did you find most satisfying during your stay in Hijra Bank?', type: 'textarea', placeholder: 'Share what you valued most' },
    { name: 'mostFrustrating', label: 'What did you find most frustrating during your stay in Hijra Bank?', type: 'textarea', placeholder: 'Share what frustrated you most' },
