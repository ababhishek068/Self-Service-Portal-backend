  ...
  return (
    <MultiStepRequestPage
      ...
      headerFields={[
        ...
        { name: 'requestType', label: 'Request Type', type: 'select', options: transportRequestTypeOptions, valuePaths: ['RequestType', 'Request_Type'], valueMap: { city: 'City', trip: 'Field Trip', 'field trip': 'Field Trip', field: 'Field Trip', '0': 'City', '1': 'Field Trip', '2': 'Field Trip' } },
