...
export function PurchaseRequisition() {
  ...
  return (
    <MultiStepRequestPage
      ...
      description="Create the purchase header, then add item lines with location and reason. Approval requires each selected item or service to exist in the finalized budget for the requesting department; invalid draft lines can be edited or deleted."
      module={module}
      ...
      line={{
        ...
        fields: [
          ...
          },
          {
            ...
            type: 'select',
            placeholder: 'Select the budgeted item or service',
            optionsByField: {
              field: 'type',
