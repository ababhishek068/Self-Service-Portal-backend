...
PortalAssetTransferMgt also uses the same Custom Approvals workflow as Asset
Transfer Card page 50584, so Request Approval creates real Approval Entry rows
and Cancel Approval cancels the Business Central workflow.
