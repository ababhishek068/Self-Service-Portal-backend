  ...
  return (
    <RequestFormPage
      ...
      fields={[
        ...
        { name: 'division', label: 'Division', type: 'select', options: divisions.options, valuePaths: ['Division'], placeholder: divisions.isLoading ? 'Loading divisions…' : divisions.isError ? 'Could not load divisions' : 'Select division' },
        { name: 'department', label: 'Department', type: 'select', options: departments.options, valuePaths: ['Department'], placeholder: departments.isLoading ? 'Loading departments…' : departments.isError ? 'Could not load departments' : 'Select department' },
      ...
      detailFields={[
        ...
        { label: 'Division', paths: ['payload.Division'] },
        { label: 'Department', paths: ['payload.Department'] },
