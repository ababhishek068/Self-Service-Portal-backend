query 50074 "Receipt & Payment Types"
{
    ...
    elements
    {
        dataitem(ReceiptsandPaymentTypes; "Receipts and Payment Types")
        {
            ...
            column(GLAccountName; "GL Account Name")
            {
            }
            // The portal uses this to distinguish ERP-calculated rates from
            // advance types whose daily rate must be entered manually.
            column(RateSource; "Rate Source") { }
