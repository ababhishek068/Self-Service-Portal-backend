HIJRA COMPLETE SUITE FINAL v1.0.3.72 — 28 July 2026
*** DEPLOY THIS ZIP ONCE — ALL MODULES INCLUDED ***

Do NOT use older zips (including 1.0.3.70 and 1.0.3.71, which do not contain
the complete Gate Pass list-and-detail dimension fix).
