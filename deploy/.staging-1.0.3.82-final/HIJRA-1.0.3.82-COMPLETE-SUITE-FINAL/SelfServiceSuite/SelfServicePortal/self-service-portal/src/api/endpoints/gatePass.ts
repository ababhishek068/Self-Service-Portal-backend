...
export type GatePassSource = 'storeIssue' | 'transferOrder' | 'assetTransfer' | 'maintenance'
...
export const gatePassSources: Array<{
  ...
  {
    value: 'maintenance',
    label: 'Maintained Asset Gate Passes',
    singularLabel: 'Maintained Asset Gate Pass',
    description: 'Gate passes generated from approved fixed-asset or vehicle maintenance requests.',
  },
]
