...
/// </summary>
query 52168 "QyPortalFuelMaintExtra"
{
    QueryType = Normal;
    ...
    elements
    {
        dataitem(Extra; "Portal Fuel Maint. Extra")
        {
            ...
            column(RequestedFuelLitres; "Requested Fuel Litres") { }
            column(VehicleFuelRating; "Vehicle Fuel Rating") { }
            column(VehicleCurrentReading; "Vehicle Current Reading") { }
        }
    }
}
