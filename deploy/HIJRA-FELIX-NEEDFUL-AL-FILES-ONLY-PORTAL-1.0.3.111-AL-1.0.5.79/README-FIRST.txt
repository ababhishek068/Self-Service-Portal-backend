HIJRA SSP — NEEDFUL AL FILES ONLY — PORTAL 1.0.3.111 / AL 1.0.5.79
====================================================================

IMPORTANT
---------
Portal v1.0.3.111 contains the UI/backend fixes. The following BC objects in
...
Portal v1.0.3.111 also presents Store Requisition according to the complete
...
Portal v1.0.3.111 fixes Facility list values without requiring another AL
...
Portal v1.0.3.111 also corrects Maintenance Request detail presentation. It
...
1.0.5.79 AL merge and normal app upgrade before portal 1.0.3.111 is tested.

Portal v1.0.3.111 corrects the browser timeout for Business Central-backed
...
Portal v1.0.3.111 also fixes the user-specific Staff Claim creation error where
