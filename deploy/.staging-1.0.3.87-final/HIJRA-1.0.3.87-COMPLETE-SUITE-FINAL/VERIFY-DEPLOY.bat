...
echo VERIFY DEPLOY - HIJRA v1.0.3.87 COMPLETE SUITE FINAL
if exist "dist\server.js" (echo [OK] dist\server.js) else (echo [FAIL] dist\server.js)
findstr /M /C:"1.0.3.87" dist\portalApi.js >nul 2>&1 && echo [OK] backend v1.0.3.87 || echo [FAIL] backend version
