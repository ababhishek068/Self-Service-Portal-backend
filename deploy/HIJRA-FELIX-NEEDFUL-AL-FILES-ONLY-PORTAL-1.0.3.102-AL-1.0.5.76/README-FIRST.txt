HIJRA SSP — NEEDFUL AL FILES ONLY — PORTAL 1.0.3.102 / AL 1.0.5.76
====================================================================

IMPORTANT
---------
Portal v1.0.3.102 contains the UI/backend fixes. The following BC objects in
...
The package contains 30 AL files: only the cumulative AL files needed for the
...
6. Confirm the three Query files above are included before compiling. Missing
   query files cause blank salary, imprest and staff-claim fields in the portal.
7. Confirm the Web Services page contains published service CuPortalTraining.
