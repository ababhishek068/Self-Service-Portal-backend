...
/// Read by query 52124 "QyProcurementPlanHeader"; written by codeunit 52122 (CuPortalFacility).
/// </summary>
table 52124 "Portal Procurement Plan Hdr."
{
    ...
    fields
    {
        ...
        field(3; "Global Dimension 2"; Code[20]) { Caption = 'Department or District'; }
