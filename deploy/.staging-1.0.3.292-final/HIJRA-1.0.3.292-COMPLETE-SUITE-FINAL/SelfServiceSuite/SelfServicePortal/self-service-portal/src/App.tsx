...
import { ProcurementPlan } from '@/pages/facility/ProcurementPlan'
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedLayout />}>
        ...
        <Route path="facility/procurement-plan" element={<ProcurementPlan />} />
        ...
        <Route path="facility/gate-pass/maintenance" element={<GatePass source="maintenance" />} />
