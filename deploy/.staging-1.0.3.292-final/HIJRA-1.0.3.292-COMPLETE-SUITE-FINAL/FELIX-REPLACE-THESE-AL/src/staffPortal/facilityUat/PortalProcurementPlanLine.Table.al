...
/// Read by query 52170 "QyProcurementPlanLines"; written by codeunit 52161 (CuPortalFacility).
/// </summary>
table 52165 "Portal Procurement Plan Line"
{
    ...
    fields
    {
        ...
        field(2; Department; Code[20]) { Caption = 'Department or District'; }
