...
export function TransferOrder() {
  ...
  return (
    <MultiStepRequestPage
      // UAT R49-R54: Transfer Order is strictly the inventory move between locations.
      // Vehicle/tool handover lives on the dedicated Asset Transfer page (table 50278).
