...
export const EMPLOYEE_EXIT_FIELDS: Record<EmployeeExitRequestType, EmployeeExitFieldConfig[]> = {
  transfer: [
    ...
    { name: 'desiredDepartment', label: 'Requested department', type: 'text', placeholder: 'Department you are requesting to join', required: true },
    { name: 'desiredLocation', label: 'Requested branch / duty station', type: 'text', placeholder: 'Branch, office, city, or duty station', required: true },
