...
export function GatePass({ source }: { source: GatePassSource }) {
  ...
  const lineColumns = source === 'storeIssue'
    ? [
        ...
        { label: 'FA / Item No.', paths: ['itemNo', 'ItemNo', 'Item_No', 'No', 'LineNo', 'Line_No'] },
        { label: 'Description', paths: ['description', 'Description'] },
        { label: 'Tag No.', paths: ['tagNo', 'TagNo', 'Tag_No'] },
        {
          label: 'Quantity',
          paths: [
            'quantityIssued',
  ...
  return (
    <RequestFormPage
      ...
      fields={[
        ...
        { name: 'timeOut', label: 'Time Out', type: 'time', placeholder: 'Select departure time' },
      ...
      detailFields={[
        ...
        { label: 'Returned Status', paths: ['payload.Returned', 'payload.ReturnedStatus', 'payload.Returned_Status'], format: 'returned' },
        { label: 'Date Returned', paths: ['payload.DateIn', 'payload.Date_In', 'payload.ReturnDate', 'payload.Return_Date'], format: 'date' },
        {
          label: 'Closure Status',
          paths: ['payload.GatePassClosed', 'payload.Gate_Pass_Closed'],
          format: 'closure',
        },
        {
          label: 'Sector',
