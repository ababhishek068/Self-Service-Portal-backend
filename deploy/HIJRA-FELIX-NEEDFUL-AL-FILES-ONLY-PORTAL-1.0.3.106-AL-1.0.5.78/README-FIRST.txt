HIJRA SSP — NEEDFUL AL FILES ONLY — PORTAL 1.0.3.106 / AL 1.0.5.78
====================================================================

IMPORTANT
---------
Portal v1.0.3.106 contains the UI/backend fixes. The following BC objects in
...
Portal v1.0.3.106 also presents Store Requisition according to the complete
