HIJRA SSP — NEEDFUL AL FILES ONLY — PORTAL 1.0.3.117 / AL 1.0.5.80
====================================================================

IMPORTANT
---------
Portal v1.0.3.117 contains the UI/backend fixes. The following BC objects in
...
Portal v1.0.3.117 also presents Store Requisition according to the complete
...
Portal v1.0.3.117 fixes Facility list values without requiring another AL
...
Portal v1.0.3.117 also corrects Maintenance Request detail presentation. It
...
1.0.5.80 AL merge and normal app upgrade before portal 1.0.3.117 is tested.

Portal v1.0.3.117 corrects the browser timeout for Business Central-backed
...
Portal v1.0.3.117 also fixes the user-specific Staff Claim creation error where
...
Portal v1.0.3.117 corrects Leave Approval Detail without another AL change.
...
Portal v1.0.3.117 also keeps the employee-side Approval Workflow visible for
...
Portal v1.0.3.117 removes Location / Coordinates, Sign-in Location and Sign-out
...
Portal v1.0.3.117 fixes Training Need Assessment course selection. The
...
Portal v1.0.3.117 / AL v1.0.5.80 fixes the Imprest ERP daily-rate identity
...
Portal v1.0.3.117 cleans the Imprest Surrender selection preview. Fields that
