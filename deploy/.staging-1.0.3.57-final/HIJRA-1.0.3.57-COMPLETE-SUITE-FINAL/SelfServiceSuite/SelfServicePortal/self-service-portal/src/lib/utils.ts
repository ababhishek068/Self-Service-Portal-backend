...
/** Finance modules allow cancel on draft and pending approval (BC Status=Pending maps to Draft). */
export const FINANCE_CANCEL_STATUSES: Array<'Draft' | 'Pending Approval'> = ['Draft', 'Pending Approval']
