query 50076 "Imprest Lines 2"
{
    ...
    elements
    {
        dataitem(ImprestLines; "Imprest Lines")
        {
            ...
            column(DestinationCode; Destination) { }
            // UAT 29/07/2026: expose the line duty area so an imprest
            // surrender can populate Place of Duty from its source line.
            column(DutyArea; "Duty Area") { }
