HIJRA SSP — NEEDFUL AL FILES ONLY — PORTAL 1.0.3.110 / AL 1.0.5.79
====================================================================

IMPORTANT
---------
Portal v1.0.3.110 contains the UI/backend fixes. The following BC objects in
...
Portal v1.0.3.110 also presents Store Requisition according to the complete
...
Portal v1.0.3.110 fixes Facility list values without requiring another AL
...
Portal v1.0.3.110 also corrects Maintenance Request detail presentation. It
...
1.0.5.79 AL merge and normal app upgrade before portal 1.0.3.110 is tested.

Portal v1.0.3.110 corrects the browser timeout for Business Central-backed
