HIJRA SSP — NEEDFUL AL FILES ONLY — PORTAL 1.0.3.115 / AL 1.0.5.79
====================================================================

IMPORTANT
---------
Portal v1.0.3.115 contains the UI/backend fixes. The following BC objects in
...
Portal v1.0.3.115 also presents Store Requisition according to the complete
...
Portal v1.0.3.115 fixes Facility list values without requiring another AL
...
Portal v1.0.3.115 also corrects Maintenance Request detail presentation. It
...
1.0.5.79 AL merge and normal app upgrade before portal 1.0.3.115 is tested.

Portal v1.0.3.115 corrects the browser timeout for Business Central-backed
...
Portal v1.0.3.115 also fixes the user-specific Staff Claim creation error where
...
Portal v1.0.3.115 corrects Leave Approval Detail without another AL change.
...
Portal v1.0.3.115 also keeps the employee-side Approval Workflow visible for
...
Portal v1.0.3.115 removes Location / Coordinates, Sign-in Location and Sign-out
...
Portal v1.0.3.115 fixes Training Need Assessment course selection. The
...
mapping correction and requires no additional AL object beyond 1.0.5.79.
