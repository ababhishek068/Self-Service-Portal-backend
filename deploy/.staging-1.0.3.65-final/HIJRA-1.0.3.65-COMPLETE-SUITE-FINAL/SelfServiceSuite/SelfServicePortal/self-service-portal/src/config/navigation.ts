...
export const navigationMenu: NavItem[] = [
  { label: 'Dashboard', path: '/', icon: Gauge },
  {
    ...
    children: [
      ...
      { label: 'Emergency Staff Loan', path: '/hr/request-letters/emergency-staff-loan', icon: Landmark },
      {
        ...
        icon: FileText,
        children: [
          { label: 'My Letter Requests', path: '/hr/request-letters', icon: ClipboardList },
  ...
  },
  {
    ...
    children: [
      ...
      // Request first (the document staff raise), then Settlement.
      { label: 'Petty Cash Request', path: '/finance/petty-cash-replenishment', icon: Banknote },
      { label: 'Petty Cash Settlement', path: '/finance/petty-cash', icon: ReceiptText },
    ],
  },
  {
    label: 'Facilities',
    ...
    children: [
      ...
      { label: 'Transfer Orders', path: '/facility/transfer-order', icon: PackageCheck },
      {
        ...
        path: '/facility/asset-transfer',
        icon: ArrowRightLeft,
      },
      { label: 'Procurement Plan', path: '/facility/procurement-plan', icon: ClipboardList },
    ],
  },
  {
    label: 'Approvals',
  ...
  },
  {
    ...
    roles: ['hod'],
    children: [
      { label: 'Staff Attendance', path: '/hr/attendance', icon: ClipboardCheck },
