...
export function TransportRequest() {
  ...
  return (
    <MultiStepRequestPage
      ...
      headerFields={[
        // BC returns the Vehicle Type option text: "City" or "Trip" (blank on old drafts).
        { name: 'requestType', label: 'Request Type', type: 'select', options: transportRequestTypeOptions, valuePaths: ['Vehicle_Type', 'VehicleType', 'RequestType', 'Request_Type'], valueMap: { city: 'City', trip: 'Field Trip', 'field trip': 'Field Trip', field: 'Field Trip', '0': 'City', '1': 'Field Trip', '2': 'Field Trip' } },
