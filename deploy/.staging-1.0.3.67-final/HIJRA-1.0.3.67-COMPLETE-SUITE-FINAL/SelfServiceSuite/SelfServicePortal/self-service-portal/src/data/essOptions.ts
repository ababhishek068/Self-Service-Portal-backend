...
/** ESS hospital categories: 1 = Govt, 2 = Non Govt, 3 = Online/Outline. */
...
/**
 * BC "Vehicle Type" is an Option (" ", City, Trip), so City = 1 and Trip = 2.
 * Send the text labels — the backend maps them onto the BC option indexes.
 * (The old 0/1 numeric values wrote blank/City into BC, which is why Field
 * requests "became City" during UAT.)
 */
