...
/** ESS hospital categories: 1 = Government, 2 = Non-Government, 3 = Online / outline branch. */
export const hospitalCategoryOptions = [
  { label: 'Government hospital (100% refund)', value: '1' },
  { label: 'Non-Government / no agreement (60% refund)', value: '2' },
  { label: 'Online / outline branch — no agreement (90% refund)', value: '3' },
]
...
export const storeLineTypeOptions = [
  { label: 'Item (consumable / stock)', value: '1' },
  { label: 'Fixed asset', value: '2' },
]
