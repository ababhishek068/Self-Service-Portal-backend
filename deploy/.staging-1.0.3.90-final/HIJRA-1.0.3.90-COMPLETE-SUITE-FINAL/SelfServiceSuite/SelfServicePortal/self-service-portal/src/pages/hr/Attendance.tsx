...
function attendancePlace(location?: string, coordinates?: string) {
  const values = [location, coordinates]
...
export function Attendance() {
  ...
  const columns: DataTableColumn<AttendanceRow>[] = [
    ...
    { id: 'hours', header: 'Hours Worked', cell: (row) => attendanceHours(row.hoursWorked) },
    {
      ...
      cell: (row) => attendancePlace(row.signInLocation, row.signInCoordinates || row.locationCoordinates),
    },
    {
      id: 'mac',
      header: 'MAC Address',
  ...
  const teamColumns: DataTableColumn<AttendanceRow>[] = [
    ...
    {
      id: 'signInPlace',
      header: 'Sign-in Location',
      cell: (row) => attendancePlace(row.signInLocation, row.signInCoordinates || row.locationCoordinates),
    },
    {
      id: 'signOutPlace',
      header: 'Sign-out Location',
      cell: (row) => attendancePlace(row.signOutLocation, row.signOutCoordinates),
    },
    {
      id: 'mac',
      header: 'MAC Address',
