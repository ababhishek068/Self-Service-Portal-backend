...
page 51551 "Tender Cancellation Card"
{
    ApplicationArea = All;
    Caption = 'Tender Cancellation Card';
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Original Closing Date"; Rec."Original Closing Date")
                {
                    ToolTip = 'Specifies the value of the Original Closing Date field.', Comment = '%';
                }
