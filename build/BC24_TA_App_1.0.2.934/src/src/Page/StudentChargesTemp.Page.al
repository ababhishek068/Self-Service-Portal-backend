Page 51236 "Student Charges Temp"
{
    PageType = List;
    SourceTable = "Student Charges Buffer";
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1000000000)
            {
                ...
                field(DistributionAccount; Rec."Distribution Account")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Distribution Account field.';
                }
