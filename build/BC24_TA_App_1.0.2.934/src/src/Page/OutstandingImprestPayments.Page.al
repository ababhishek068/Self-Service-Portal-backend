page 50594 "Outstanding Imprest Payments"
{
    CardPageID = "Outst. Imprest Payments Card";
    PageType = List;
    UsageCategory = Lists;
    ApplicationArea = Basic;
    SourceTable = "Payments Header";
    SourceTableView = WHERE("Payment Type" = FILTER("Petty Cash"), "Request Type" = filter("Oustanding Imprest"),
