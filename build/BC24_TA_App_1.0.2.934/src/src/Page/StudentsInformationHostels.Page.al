Page 50112 "Students Information (Hostels)"
{
    // CardPageID = "Students Hostels";
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(BlackListedReason; Rec."Black Listed Reason")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Black Listed Reason field.';
                }
    ...
    actions
    {
        area(processing)
        {
            ...
            action(StudentRoom)
            {
                ...
                Image = List;
                Promoted = true;
                RunObject = Page "Student Hostel Rooms";
