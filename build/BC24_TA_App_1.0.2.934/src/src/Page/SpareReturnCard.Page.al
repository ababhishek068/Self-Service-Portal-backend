...
page 51577 "Spare Return Card"
{
    ApplicationArea = All;
    Caption = 'Spare Return Card';
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            ...
            part(accessoryreturn;"Return Accessories")
        {
            SubPageLink="Asset No"=field("Vehicle No"),"Tag No"=field("Plate No"),"Return Code"=field("Return No");
        }
        }
        area(FactBoxes)
        {
            part(docattachments;"Document Attachments")
            {
                ApplicationArea=all;
                Caption='Attachments';
                SubPageLink="Table ID"=const(Database::"Spare Part Returns"),"No."=field("Return No");
            }
        }
