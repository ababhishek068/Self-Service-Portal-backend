page 50348 "Applicant Picture"
{
    ...
    layout
    {
        area(content)
        {
            field("Applicant Photo"; Rec."Applicant Photo")
            {
                ApplicationArea = All;
                ShowCaption = false;
        ...
        area(processing)
        {
            ...
            action(ImportPicture)
            {
                ...
                begin
                    ...
                    if "Applicant Photo".HasValue then
                    ...
                    Clear(Rec."Applicant Photo");
                    "Applicant Photo".ImportFile(FileName, ClientFileName);
            ...
            action(ExportFile)
            {
                ...
                begin
                    ...
                    ExportPath := TemporaryPath + Rec."Serial No" + Format("Applicant Photo".MediaId);
                    "Applicant Photo".ExportFile(ExportPath);
    ...
    begin
        ...
        if Camera.HasPicture() then begin
            ...
            Clear(Rec."Applicant Photo");
            "Applicant Photo".ImportStream(Instream, 'Customer Picture');
            if not Rec.Modify(true) then
                Rec.Insert(true);
        end;
    ...
    begin
        DeleteExportEnabled := "Applicant Photo".HasValue;
    end;
