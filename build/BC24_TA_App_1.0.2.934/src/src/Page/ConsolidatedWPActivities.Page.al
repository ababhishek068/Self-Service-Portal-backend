page 50220 "Consolidated WP Activities"
{
    Caption = 'Consolidated Workplan Activities';
    UsageCategory = Lists;
    ApplicationArea = All;
    PageType = List;
    SourceTable = "Workplan Activities";
    SourceTableView = where(Ammended = filter(false));
    ...
    begin
        ...
        if Rec."Report Grouping" = '' then begin
            if Rec.Type = Rec.Type::Item then Begin
                Item.RESET;
                if Item.GET(Rec."No.") then Begin
                    Rec."Report Grouping" := Item."Inventory Posting Group";
                end;
            end;

            if Rec.Type = Rec.Type::"G/L Account" then Begin
                Rec."Report Grouping" := Rec."No.";
            end;
