Page 50188 "Int. Audit Notification Card"
{
    PageType = Card;
            ...
            action("Send Notification")
            {
                ...
                begin
                    ...
                    if TbUserSetup.Find('-') then begin
                        ...
                        varMessage := 'This is to notify you that you will be audited on date ' + format(Rec."Audit Date") + ' Please login to the ERP system for more information';
