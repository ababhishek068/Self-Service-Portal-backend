table 50978 "Tender Cancellation"
{
    Caption = 'Tender Cancellation';
    DataClassification = ToBeClassified;
    DrillDownPageId = "Tender Cancellation list";
    ...
    fields
    {
        ...
        field(7; Reason; Code[20])
        {
            Caption = 'Reason';
            TableRelation="Tender Cancellation Reasons"."Reason Code";
            trigger OnValidate()
            var 
            tendercancellation: Record "Tender Cancellation Reasons";
            begin
                if tendercancellation.Get(Reason) then begin
                    "Reason Description":=tendercancellation."Reason Description";
                end;
        ...
        field(16;"Reason Description";Text[100]){}
    }
    keys
    {
