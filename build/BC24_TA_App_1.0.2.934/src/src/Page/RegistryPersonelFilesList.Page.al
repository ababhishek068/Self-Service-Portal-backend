Page 51020 "Registry Personel Files List"
{
    CardPageID = "Registry Personel Files Card";
    PageType = List;
    SourceTable = "Registry Files";
    SourceTableView = where("File Status" = filter(New), "File Type" = filter(Outbound));
    ApplicationArea = All;
    ...
    begin
        Rec."File Type" := Rec."File Type"::Outbound;
    end;
}
