Report 50366 "Store Issue"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Storeissue.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Store Requistion Header"; "Store Requistion Header")
        {
            ...
            column(Store_Issue_No;"Store Issue No"){}
            ...
            dataitem("Store Requistion Lines"; "Store Requistion Lines")
            {
                ...
                column(isuedate;storeH."Issue Date"){}
                column(issueno;storeH."Store Issue No"){}
                column(Requistion_No;"Requistion No"){}
                column(reqno;storeh."No."){}
