report 50116 "PR Payments and Deductions"
{
    // version FIN-24-AUG-18

    DefaultLayout = RDLC;
    RDLCLayout = './PR Payments and Deductions.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("HR-Employee"; "HR-Employee")
        {
            ...
            column(Contract_Type; "HR-Employee"."Contract Type") { }
            ...
            begin
                ...
                //Other Earnings
                fnSetrangePRPeriodTrans;
                PRPeriodTrans.SETRANGE("Group Order", 3);
                PRPeriodTrans.SETRANGE("Sub Group Order", 0);
                IF PRPeriodTrans.FINDFIRST THEN BEGIN
                    PRPeriodTrans.CalcSums(Amount);
                    OtherEarnings := PRPeriodTrans.Amount;
                END;
    ...
    begin
        ...
        if SelectedPeriod = 0D then
            Evaluate(SelectedPeriod, "HR-Employee".GetFilter("Period Filter"));
