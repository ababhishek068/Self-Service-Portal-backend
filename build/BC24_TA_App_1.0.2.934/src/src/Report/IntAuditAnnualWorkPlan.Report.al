Report 50300 "Int. Audit Annual Work Plan"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/IntAuditAnnualWorkPlan.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Int. Audit Work Plans"; "Int. Audit Work Plans")
        {
            ...
            dataitem("Int. Audits"; "Int. Audits")
            {
                ...
                column(auditAreaName; auditAreaName) { }
                ...
                begin
                    auditAreaName := '';
                    TbAuditAreas.Reset();
                    TbAuditAreas.SetRange(Code, "Int. Audits"."Audit Area");
                    if (TbAuditAreas.Find('-')) then begin
                        auditAreaName := TbAuditAreas."Area of Audit";
                    end;
                end;
            }
