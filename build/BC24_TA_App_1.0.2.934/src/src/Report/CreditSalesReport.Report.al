report 50356 "Credit Sales Report"
{
    ApplicationArea = All;
    Caption = 'Credit Sales Report';
    DefaultLayout = RDLC;
    RDLCLayout = './NewLayouts/Creditsales.rdl';
    ...
    var
        ...
        info3: label 'Reminder: A complete receipt must be issued not just';
        counter: Integer;
        payee: text[100];
        cashier: text[50];
