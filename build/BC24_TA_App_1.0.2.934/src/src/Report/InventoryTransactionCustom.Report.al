report 50059 "Inventory - Transaction Custom"
{
    DefaultLayout = RDLC;
        ...
        dataitem(Item; Item)
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem("Item Ledger Entry"; "Item Ledger Entry")
                {
                    ...
                    column(OpeningInventoryQty; StartOnHandQty) { }
                    column(OpeningInventoryValue; StartOnHand) { }
