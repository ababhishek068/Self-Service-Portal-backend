Report 50093 "Class List"
{
    ...
    dataset
    {
        dataitem("Student Units"; "Student Units")
        {
            ...
            RequestFilterFields = "Campus Code", Programme, Stage, Unit, Semester, "Unit Class Code", "Student Type Filter", "Mode of Study";
            ...
            var
                UnitsSubject: Record "Units/Subjects";
            begin
                ...
                UnitsSubject.Reset();
                UnitsSubject.SetFilter("Programme Code", Programme);
                UnitsSubject.SetFilter(Code, Unit);

                if UnitsSubject.find('-') then
                    UnitName := UnitsSubject.Desription;
            end;
