Report 50123 "Int. Audit Meeting Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/IntAuditMeetingReport.rdlc';
    ApplicationArea = All;
        ...
        dataitem("Int. Audit Work Plans"; "Int. Audit Work Plans")
        {
            ...
            dataitem("Int. Audits"; "Int. Audits")
            {
                ...
                dataitem("Int. Audit Quarters"; "Int. Audit Quarters")
                {
                    ...
                    dataitem("Int. Audit Meetings"; "Int. Audit Meetings")
                    {
                        DataItemLink = Quarter = field(Code);
                        RequestFilterFields = Code;
                        column(description_IntAuditMeetings; "Int. Audit Meetings".Description) { }
                        column(quarter_IntAuditMeetings; "Int. Audit Meetings".Quarter) { }
                        dataitem("Int. Audit Meeting Minutes"; "Int. Audit Meeting Minutes")
                        {
                            DataItemLink = "Meeting Code" = field(Code);
                            column(minute_IntAuditMeetingMinute; "Int. Audit Meeting Minutes"."Minute Description") { }
                        }
                        dataitem("Int. Audit Meeting Agenda"; "Int. Audit Meeting Agenda")
                        {
                            DataItemLink = "Meeting Code" = field(Code);
                            column(agenda_IntAuditMeetingAgenda; "Int. Audit Meeting Agenda".Agenda) { }
                        }
                        dataitem("Int. Audit Meeting Attendance"; "Int. Audit Meeting Attendance")
                        {
                            DataItemLink = "Meeting Code" = field(Code);
                            column(attendee_IntAuditMeetingAttendance; "Int. Audit Meeting Attendance".Attendee) { }
                            column(name_IntAuditMeetingAttendance; "Int. Audit Meeting Attendance".Name) { }
                        }
                    }
                }
            }
