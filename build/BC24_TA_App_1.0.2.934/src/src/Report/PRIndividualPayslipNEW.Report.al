Report 50161 "PR Individual Payslip - NEW"
{
    ...
    dataset
    {
        dataitem("HR-Employee"; "HR-Employee")
        {
            ...
            column(GlobalDimension1Code_HREmployees; "HR-Employee"."Global Dimension 1 Code") { }
            ...
            column(GlobalDimension2Code_HREmployees; "HR-Employee"."Global Dimension 2 Code") { }
            ...
            begin
                ...
                if "HR-Employee"."Date Of Birth" <> 0D then begin
                    CurrYear := Date2dmy(Today, 3);
                    BirthYear := Date2dmy("HR-Employee"."Date Of Birth", 3);
                    currAge := CurrYear - BirthYear;

                    if "HR-Employee".Disabled = "HR-Employee".Disabled::Yes then begin
