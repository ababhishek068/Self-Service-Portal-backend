Report 50102 "Fail List"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Student No.", Unit) order(ascending) where("Cust Exist" = filter(> 0), "Grade Exists" = filter(false));
            RequestFilterFields = "Campus Code", Programme, Stage, Unit, Semester, "Unit Class Code", "Student Type Filter";
