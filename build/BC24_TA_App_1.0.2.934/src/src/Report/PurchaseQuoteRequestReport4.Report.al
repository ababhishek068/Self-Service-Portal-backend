Report 50244 "Purchase Quote Request Report4"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PurchaseQuoteRequestReport2.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Purchase Quote Header"; "Purchase Quote Header")
        {
            ...
            column(PostingDescription_PurchaseQuoteHeader; "Purchase Quote Header"."Request Description") { }
