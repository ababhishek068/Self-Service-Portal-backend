...
Report 52520 "Trial BalanceX"
{
    DefaultLayout = RDLC;
    RDLCLayout = './NewLayouts/Trial BalanceX.rdl';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                Totalcredit := 0;
                Totaldebitbal := 0;
                "G/L Account".CalcFields("G/L Account"."Net Change", "G/L Account"."Balance at Date");
                ...
                if "G/L Account"."Account Type" = "G/L Account"."account type"::Posting then begin
                    ...
                    if "G/L Account"."Net Change" < 0 then
                        Totalcredit := Totalcredit + "G/L Account"."Net Change";
                end;

                if "G/L Account"."Account Type" = "G/L Account"."account type"::Posting then begin
                    if "G/L Account"."Balance at Date" > 0 then
                        Totaldebitbal := Totaldebitbal + "G/L Account"."Balance at Date";
                    if "G/L Account"."Balance at Date" < 0 then
                        Totalcreditbal := Totalcreditbal + "G/L Account"."Balance at Date";
                end;
            end;
