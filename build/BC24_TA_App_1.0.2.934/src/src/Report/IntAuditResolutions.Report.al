Report 50124 "Int. Audit Resolutions"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/IntAuditResolutions.rdlc';
    ApplicationArea = All;
        ...
        dataitem("Int. Audit Work Plans"; "Int. Audit Work Plans")
        {
            ...
            dataitem("Int. Audits"; "Int. Audits")
            {
                ...
                dataitem("Int. Audit Quarters"; "Int. Audit Quarters")
                {
                    ...
                    dataitem("Int. Audit Resolutions"; "Int. Audit Resolutions")
                    {
                        DataItemLink = Quarter = field(Code);
                        column(ReportForNavId_70; 70) { }
                        column(LineNo_IntAuditResolutions; "Int. Audit Resolutions"."Line No.") { }
                        column(Audit_IntAuditResolutions; "Int. Audit Resolutions".Audit) { }
                        column(Quarter_IntAuditResolutions; "Int. Audit Resolutions".Quarter) { }
                        column(Status_IntAuditResolutions; "Int. Audit Resolutions".Status) { }
                        column(Description1_IntAuditResolutions; "Int. Audit Resolutions".Description) { }
                        column(expectedDate_IntAuditResolutions; "Int. Audit Resolutions"."Expected Implementation Date") { }
                        column(actualDate_IntAuditResolutions; "Int. Audit Resolutions"."Actual Implementation Date") { }
                    }
                }
            }
