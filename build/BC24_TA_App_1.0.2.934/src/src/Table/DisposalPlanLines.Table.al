Table 50725 "Disposal Plan Lines"
{
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Supplier Portal Central Setups" where(Type = filter('Disposal Justification'));
        }
        ...
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ",Donate,Sale,"Transfer to GOK","Donate to Employees";
        }
