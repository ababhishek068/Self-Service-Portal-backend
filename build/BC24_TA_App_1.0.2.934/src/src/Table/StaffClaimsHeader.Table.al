Table 50885 "Staff Claims Header"
{
    DrillDownPageID = "Staff Claim List";
    LookupPageID = "Staff Claim List";
    ...
    fields
    {
        ...
        field(35; Status; Option)
        {
            ...
            begin
                ...
                if "Final Approver Status" = "Final Approver Status"::Approved then begin
        ...
        {
            OptionMembers = Imprest,"Parttime Claim";
        }
        ...
        field(87; "Account No."; Code[20])
        {
            ...
            if ("Account Type" = const(Employee)) "HR-Employee";
            ...
            begin
                ...
                if Emp.Get("Account No.") then begin
                    ...
                    emp.CalcFields("Basic Pay");
                    "Basic Pay":=Emp."Basic Pay";
        ...
        field(91; "Employee No"; Code[20])
        {
            TableRelation = "HR-Employee"."No.";
        }
        field(92;"Basic Pay";Decimal){}
        ...
        field(70134678; "Claim From Imprest"; Boolean) { }
        field(70134679; "Imprest Doc No"; Code[20])
        {
            //TableRelation = "Imprest Header"."No." where("Employee No." = field("Employee No"));
            TableRelation = "Imprest Header"."No." where("Employee No." = field("Account No."));
        }
    ...
    begin
        ...
        if "No." = '' then begin
            ...
            if "Payment Type" = "payment type"::Imprest then begin
                ...
                "No." := NoSeriesMgt.GetNextNo(GenLedgerSetup."Staff Claim No", 0D, true);
            end
        end;
