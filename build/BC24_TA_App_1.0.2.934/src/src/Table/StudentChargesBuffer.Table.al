Table 50078 "Student Charges Buffer"
{
    DrillDownPageID = "Student Charges Temp";
    LookupPageID = "Student Charges Temp";
    ...
    fields
    {
        ...
        field(142; "Settlment Type"; Code[20])
        {
        ...
        field(60; "Excluded In Plan"; Boolean)
        {
            CalcFormula = lookup(Charge."Exclude In PayPlan" where(Code = field(Code)));
            FieldClass = FlowField;
        }
        field(61; "Hostel Charge"; Boolean) { }
