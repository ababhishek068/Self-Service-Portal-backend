Table 50745 "Bid Analysis"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("RFQ Awards".Type WHERE("Vendor No" = FIELD("Vendor No."),
                                                          "RFQ No" = FIELD("RFQ No.")));
            FieldClass = FlowField;
        ...
        {
            FieldClass = FlowField;
            CalcFormula = Count("Bid Analysis" WHERE("RFQ No." = field("RFQ No."), Select = filter(true), "Item No." = field("Item No.")));
        }
    ...
    keys
    {
        ...
        key(Key2; "Item No.") { }
        key(Key3; "Vendor No.") { }
        key(Key4; "RFQ No.", "Item No.", Amount) { }
    }
