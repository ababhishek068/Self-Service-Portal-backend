Table 50737 "Daily Menu"
{
    ...
    fields
    {
        ...
        field(18; "Food Category"; Option)
        {
            OptionCaption = ',Beverages,Snacks,Main Meals,Dessert';
            OptionMembers = ,Beverages,Snacks,"Main Meals",Dessert;
        }
