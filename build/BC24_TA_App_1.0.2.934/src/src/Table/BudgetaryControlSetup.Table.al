Table 50904 "Budgetary Control Setup"
{
    ...
    fields
    {
        ...
        field(116; "Ignore Budget Departments"; Boolean) { }
        ...
        field(26; "Check Procurement Plan"; Boolean) { }
        field(27; "Check Budget On"; Option)
        {
            OptionCaption = 'Requisition,Approve';
            OptionMembers = Requisition,Approve;
        }
    }
