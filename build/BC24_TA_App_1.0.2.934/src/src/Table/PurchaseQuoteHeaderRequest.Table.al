Table 50872 "Purchase Quote Header Request"

{
    ...
    fields
    {
        ...
        field(19; "Expected Opening Date"; Date)
        {
            ...
            begin
                if "Expected Closing Date" <> 0D then
                    if "Expected Opening Date" > "Expected Closing Date" then error('Please note that opening date can not be after closing date');
            end;
        }
        ...
        field(21; "Expected Closing Date"; Date)
        {
            ...
            trigger OnValidate()
            begin
                if "Expected Closing Date" < "Expected Opening Date" then error('Please note that closing date can not be ealier than opening date');
            end;
        }
        ...
        field(99008522; Description2; Text[50])
        {
            DataClassification = ToBeClassified;
        }
        field(99008523; "Country of Origin"; Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(99008524; Remarks; Text[50])
        {
            DataClassification = ToBeClassified;
        }
    }
