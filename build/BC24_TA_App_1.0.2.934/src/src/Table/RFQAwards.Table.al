table 50744 "RFQ Awards"
{
    ...
    fields
    {
        ...
        field(7; Description; Text[250])
        {
            ...
            CalcFormula = Lookup("Purchase Quote Header"."Request Description" WHERE("No." = FIELD("RFQ No")));

        }
        field(8; Acknowledged; Boolean)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Bid Analysis".Acknowledgement where("RFQ No." = field("RFQ No"), "Vendor No." = field("Vendor No")));
        }
        field(9; "Date of Acknowledgement"; DateTime)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Bid Analysis"."Date of Acknowledgement" where("RFQ No." = field("RFQ No"), "Vendor No." = field("Vendor No")));
        }
