...
using ABH_UAT_LIVE.ABH_UAT_LIVE;
...
page 51585 "Job Project Manager SuP"
{
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(achievemntvstarget;"Achievement Vs Target")
            {
                ApplicationArea=basic;
                Caption=' Project Target vs Achievement';
            }
            part(achievementvstargetlines;"Project Lines Graph")
            {
                ApplicationArea=basic;
                Caption='Tasks Target vs Achievement';

            }

            // part(AchievementvsTraget; "Job Achiev to Target Chart")
            // {
            //     ApplicationArea = Jobs;
            //     Caption = 'Achievement Vs Target';
            // }
            // part(actualvsTraget; "Target Vs Actual by Project")
            // {
            //     ApplicationArea = Jobs;
            //     Caption = 'Actual Result Vs Target Test';
            // }
            ...
            part(achievements; "Actual Vs Budget Chart Setup")
            {
                Caption='Project Tasks Chart Filter Setup';
                ApplicationArea = jobs;
                Visible=true;
            }
    ...
    actions
    {
        area(embedding)
        {
            ...
            {
                ApplicationArea = Jobs;
                Caption = 'project Task Graph test';
                RunObject = Page "Project Lines Graph";
                Image=CopyBudget;
                //ToolTip = 'Manage your resources'' job activities by setting up their costs and prices. The job-related prices, discounts, and cost factor rules are set up on the respective job card. You can specify the costs and prices for individual resources, resource groups, or all available resources of the company. When resources are used or sold in a job, the specified prices and costs are recorded for the project.';
            }
             action(chartproject)
            {
                ApplicationArea = Jobs;
                Caption = 'project Graph Test';
                RunObject = Page "Achievement Vs Target";
                Image=LedgerBudget;
                //ToolTip = 'Manage your resources'' job activities by setting up their costs and prices. The job-related prices, discounts, and cost factor rules are set up on the respective job card. You can specify the costs and prices for individual resources, resource groups, or all available resources of the company. When resources are used or sold in a job, the specified prices and costs are recorded for the project.';
            }
        }
