...

{
    ...
    actions
    {
        area(processing)
        {
            ...
            {
                Caption = 'Reports';
                action("Print Leave Requisition")
                {
                    Caption = 'Print Leave Requisition';
                    ...
                    trigger OnAction()
                    var
                        LeaveApplication: Report "Leave Application";
                    begin
                        HRLeaveApp.Reset();
                        ;
                        HRLeaveApp.SetRange(HRLeaveApp."Application Code", Rec."Application Code");
                        if HRLeaveApp.FindFirst() then begin
                            LeaveApplication.SetTableView(HRLeaveApp);
                            LeaveApplication.RunModal();
                        end;
                    end;
                }
            }
