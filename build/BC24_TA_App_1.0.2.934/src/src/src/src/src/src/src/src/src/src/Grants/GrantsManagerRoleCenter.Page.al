Page 50215 "Grants Manager Role Center"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
    ApplicationArea = All;
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group(GrantsManagement)
            {
                ...
                action(GrantsSurrender)
                {
                    ApplicationArea = Basic;
                    Caption = 'Grants Surrender';
                    RunObject = Page "Grant Surr List";
            ...
            group(Conference)
            {
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Conference Request';
                    RunObject = Page "Conference Requests";
                    ToolTip = 'Executes the Conference Request action.';
                }
                action(PendingConfrenceReq)
                {
                    ApplicationArea = Basic;
                    Caption = 'Pending Approval Conference Request';
                    RunObject = Page "Pending Conference  Request";
                    ToolTip = 'Executes the Pending Approval Conference Request action.';
                }
                action(ApprovedConfrenceReq)
                {
                    ApplicationArea = Basic;
                    Caption = 'Approved Conference Request';
                    RunObject = Page "Approved Conference List";
                    ToolTip = 'Executes the Approved Conference Request action.';
                }
            }
            group(Journals)
            {
