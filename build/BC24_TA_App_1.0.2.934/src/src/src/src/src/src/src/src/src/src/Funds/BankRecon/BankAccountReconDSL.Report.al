report 50112 "Bank Account Recon - DSL"
{
    ApplicationArea = All;
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "Statement No.", "Bank Account No.", "Statement Type";
            ...
            begin
                ...
                IF Bank.FIND('-') THEN BEGIN
                    ...
                    */
                    ...
                    BankAccountLedgerEntry2.SETFILTER("Posting Date", '%1..%2', 0D, "Bank Acc. Reconciliation"."Statement Date");
