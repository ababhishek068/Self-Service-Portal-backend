report 50297 "Sales - Order Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesQuote.rdlc';
    Caption = 'Sales - Order';
    PreviewMode = PrintLayout;
    ObsoleteReason = 'Replaced with report 1304 Standard Sales - Order';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(TruckNo; "Ship-to Contact") { }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(Total2; "Integer")
                    {
                        ...
                        column(BankRecNo; BankRec."No.") { }
                        column(BankRecName; BankRec.Name) { }
                        column(BankBranch; BankRec."Bank Branch No.") { }
                        column(AccountName; BankRec."Bank Account Name") { }
                        column(AccountNo; BankRec."Bank Account No.") { }
                        column(BankCurrency; BankRec."Currency Code") { }
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(BankCode; BankCode)
                    {
                        ...
                        Caption = 'Bank No';
                        ToolTip = 'Specifies the preffered bank account.';
