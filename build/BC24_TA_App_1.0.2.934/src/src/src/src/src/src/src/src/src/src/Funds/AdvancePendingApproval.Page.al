...
page 51497 "Advance Pending Approval"
{
CardPageID = "Staff Advance Request";
        ...
        area(processing)
        {
            group(Functions)
            {
                ...
                action(Approvals)
                {
                    ...
                    trigger OnAction()
                    var
                        ApprovalEntries: Page System.Automation."Approval Entries";
                    begin
    ...
    var
        ...
        GenJnlLine: Record Microsoft.Finance.GeneralLedger.Journal."Gen. Journal Line";
        LineNo: Integer;
    ...
    begin
        ...
        */
        ...
        GenJnlLine.SetRange(GenJnlLine."Journal Template Name", JTemplate);
        GenJnlLine.SetRange(GenJnlLine."Journal Batch Name", JBatch);
        Codeunit.Run(Codeunit::Microsoft.Finance.GeneralLedger.Posting."Gen. Jnl.-Post", GenJnlLine);
