report 50061 "Sales - Invoice Cust"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            begin
                ...
                Clear(PaymentInstructionsTxt); // TODO: Find Replacement for "O365 Sales Invoice Mgmt" 
    ...
    begin
        ...
        FillNameValueTable(RightHeader, CompanyInfoBankNameLbl, CompanyInfo."Bank Account No.");
        FillNameValueTable(RightHeader, CompanyInfoBankNameLbl, CompanyInfo."VAT Registration No.");
