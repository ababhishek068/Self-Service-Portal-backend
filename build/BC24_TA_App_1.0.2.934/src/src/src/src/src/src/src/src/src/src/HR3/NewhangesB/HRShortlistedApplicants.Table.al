table 50806 "HR Shortlisted Applicants"
{
    fields
    {
        ...
        field(3; "Job Application No"; Code[20])
        {
            Editable = false;
            NotBlank = true;
            TableRelation = "HR Job Applicants"."Job Application No.";
        }
        ...
        field(13; Employ; Boolean)
        {
            ...
            begin
                ...
                Employee.Region:=Applicants.Region;
        ...
        field(19; "Total Score"; Decimal) { }
        field(20; "Experience Score"; Decimal) { }
        field(21; "Publication Score"; Decimal) { }
        field(22; "Job ID"; code[20]) { }
