page 50599 "Research Card"
{
    Caption = 'Research Card';
    PageType = Card;
    RefreshOnActivate = true;
    SourceTable = Jobs;
    UsageCategory = Documents;
    ApplicationArea = All;
    //SourceTableView = WHERE(Status = CONST(Research), "Approval Status" = FILTER(Open | "Pending Approval"))
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("No."; Rec."No.")
                {
                    Caption = 'Research Note ID';
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the Research Note ID field.';
                ...
                field(Description; Rec.Description)
                {
                    ...
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the Research Title field.';
                }
        ...
        area(navigation)
        {
            Group(Objectives)
            {
                action("Obj")
                {
                    ...
                    ToolTip = 'Executes the Research Objective action.';
                }
            }
            group("W&IP")
            {
    ...
    begin
        ...
        Rec.Status := Rec.Status::Research;
    end;
