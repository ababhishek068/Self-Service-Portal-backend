page 51356 "Customer List FC"
{
    ApplicationArea = Basic, Suite, Service;
    Caption = 'Customers';
    CardPageID = "Customer Card FC";
    Editable = false;
    PageType = List;
    ...
    begin
        ...
        if UserRec.get(Database.UserId) then begin
            if UserRec."Global Dimension 1 Code" <> '' then begin
                if Rec."Global Dimension 1 Code" <> '' then begin
                    Rec.SetFilter("Global Dimension 1 Code", UserRec."Global Dimension 1 Code");
                end;
                // setfilter("Global Dimension 1 Filter", UserRec."Global Dimension 1 Code");
            end;
        end;
    end;
    ...
    begin
        ...
        if UserRec.get(Database.UserId) then begin
            if UserRec."Global Dimension 1 Code" <> '' then begin
                Rec.setfilter("Global Dimension 1 Filter", UserRec."Global Dimension 1 Code");
            end;
        end;
    end;
