Page 51325 "Bid Analysis SubForm"
{
    PageType = ListPart;
    SourceTable = "Bid Analysis";
    SourceTableView = sorting("RFQ No.", "Item No.", Amount) order(ascending);
    ApplicationArea = All;
        ...
        area(processing)
        {
            ...
            action(Award)
            {
                ...
                begin
                    ...
                    IF CONFIRM('Are you sure you want to award ' + Rec."RFQ No." + ' to Vendor ' + Rec."Vendor No." + '(' + Rec."Vendor Name" + ') for Item ' + Rec."Item No." + ' - ' + Rec.Description + '?') = TRUE THEN BEGIN
