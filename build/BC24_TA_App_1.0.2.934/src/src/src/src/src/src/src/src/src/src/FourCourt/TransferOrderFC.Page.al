page 51437 "Transfer Order FC"
{
    Caption = 'Stock Receiving';
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            group("Transfer-from")
            {
                ...
                {
                    ShowCaption = false;
                    Visible = IsFromRegionVisible;
                    field("Transfer-from Region"; Rec."Transfer-from county")
                    {
                        ApplicationArea = Location;
                        Caption = 'Region';
                        Importance = Additional;
                ...
                field("Trsf.-from Country/Region Code"; Rec."Trsf.-from Country/Region Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        IsFromRegionVisible := FormatAddress.UseCounty(Rec."Trsf.-from Country/Region Code");
                    end;
                }
            ...
            group("Transfer-to")
            {
                ...
                {
                    ShowCaption = false;
                    Visible = IsToRegionVisible;
                    field("Transfer-to Region"; Rec."Transfer-to county")
                    {
                        ApplicationArea = Location;
                        Caption = 'Region';
                        Importance = Additional;
                ...
                field("Trsf.-to Country/Region Code"; Rec."Trsf.-to Country/Region Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        IsToRegionVisible := FormatAddress.UseCounty(Rec."Trsf.-to Country/Region Code");
                    end;
                }
    ...
    var
        ...
        IsFromRegionVisible: Boolean;
        IsToRegionVisible: Boolean;
