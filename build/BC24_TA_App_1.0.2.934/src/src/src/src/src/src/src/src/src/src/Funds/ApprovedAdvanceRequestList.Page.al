Page 51553 "Approved Advance Request List"
//51553
//51555
{
    CardPageID = "Approved Staff Advance Request";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    ...
    SourceTableView = where(Posted = const(false),
                            Status = filter(Approved), "Send to payroll" = const(true), "Payroll processed" = const(false));
    ApplicationArea = All;
