Table 50434 Jobs
{
    ...
    DrillDownPageID = "Project List lookup";
    LookupPageID = "Project List lookup";
    ...
    fields
    {
        field(1; "No."; Code[20])
        {
            ...
            begin
                ...
                if Status = Status::"Concept Formulation" then begin
                    ...
                    if Status = Status::Project then begin
                        if "No." = '' then begin
                            JobSetup.Get;
                            JobSetup.TestField("Grant Task Nos");
                            NoSeriesMgt.TestManual(JobSetup."Grant Task Nos");
                            "No. Series" := '';
                        ...
                        if Status = Status::Proposal then begin
                            ...
                            if Status = Status::QA then begin
                                if "No." = '' then begin
                                    JobSetup.Get;
                                    JobSetup.TestField("QA Nos");
                                    NoSeriesMgt.TestManual(JobSetup."QA Nos");
                                    "No. Series" := '';
        ...
        field(3; Description; Text[250])
        {
            ...
            begin
                ...
                fnTrackChanges('Change in Description', xRec.Description, Description);
            end;
        }
        ...
        field(13; "Starting Date"; Date)
        {
            ...
            begin
                ...
                fnTrackChanges('Change in Starting Date', Format(xRec."Starting Date"), Format("Starting Date"));
            end;
        }
        field(14; "Ending Date"; Date)
        {
            ...
            begin
                ...
                fnTrackChanges('Change in Ending Date', Format(xRec."Ending Date"), Format("Ending Date"));
            end;
        }
        field(19; Status; Option)
        {
            Caption = 'Status';
            OptionCaption = 'Concept Formulation,Proposal,Contract,Project,Completed,Research,QA,Market';
            OptionMembers = "Concept Formulation",Proposal,Contract,Project,Completed,Research,QA,Market;
        ...
        field(21; "Global Dimension 1 Code"; Code[20])
        {
            ...
            begin
                ...
                InsertToProjectDonors;

                fnTrackChanges('Change in Donor', xRec."Global Dimension 1 Code", "Global Dimension 1 Code");
            end;
        }

        field(39003900; "Account Type"; Option)
        {
            OptionMembers = " ","Travel Advance","Staff Advance","Implementing Partner",Others,Donor,"Salary Advance",Stakeholder,Farmers,"Slaughter House","Hides and Skins Traders",Tannaries,"Footwear Manufacturers","Leather Good Manufacturers",MSMES,Clusters,"Chemical Suppliers","Accessory Suppliers","Govt. Ministries Dept Agency","Academia Res. Inst.","Sectorol Associations";
        ...
        field(24; Blocked; Option)
        {
            ...
            trigger OnValidate()
            begin
                fnTrackChanges('Change in Blocked', Format(xRec.Blocked), Format(Blocked));
            end;
        }
        ...
        field(63; Region; Text[30])
        {
            TableRelation = Region.code;
            Caption = 'Region';

        }
        field(163; Country; Text[30])
        {
        ...
        field(1003; "Bill-to Contact"; Text[20])
        {
        ...
        {
            CalcFormula = sum("G/L Entry".Amount where("Global Dimension 2 Code" = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(50010; "Received Amount"; Decimal)
        {
            CalcFormula = sum("Bank Account Ledger Entry"."Amount (LCY)" where("Global Dimension 2 Code" = field("No."),
                                                                                Amount = filter(> 0)));
            FieldClass = FlowField;
        }
        ...
        field(39003932; "Specific Objective"; Text[150]) { }
        ...
        field(50027; Title; Text[50])
        {
            Caption = 'Title of the marketing activity';
        }
        ...
        {
            CalcFormula = sum("Sales Invoice Line".Amount where("Shortcut Dimension 2 Code" = field("No.")));
            FieldClass = FlowField;
        }
        ...
        field(50053; "SubAward No."; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                fnTrackChanges('Change in SubAward No.', xRec."SubAward No.", "SubAward No.");
            end;
        }
        ...
        field(50065; "Principal Investigator name"; Text[50]) { }
        field(50066; "Response To fund Opportunity"; Boolean) { }
        field(50067; "Main Donor"; Code[50])
        {
            TableRelation = Customer."No." where("Account Type" = filter(Donor));
        }
        field(50167; "Stakeholder"; Code[50])
        {
            TableRelation = Customer."No." where("Account Type" = field("Account Type"));
        }
        field(50068; "Main Sub"; Code[50])
        {
            TableRelation = Vendor."No." where("Vendor Type" = filter("Implementing Partner"));
        }
        field(50069; "Special Contract Provision"; Text[150]) { }
        field(50070; "Funding Agency No."; Code[20])
        {

            trigger OnValidate()
            begin
                fnTrackChanges('Change in Agreement', Format(xRec."Funding Agency No."), Format("Funding Agency No."));
            end;
        }
        ...
        field(50075; "Campus Code"; code[20])
        {
            TableRelation = "Dimension Value".code where("Global Dimension No." = const(1));
        }
        ...
        field(50091; "Contracted To"; Text[50])
        {
        ...
        field(50095; "Recomendation Description"; Text[30]) { }
        ...
        field(50104; "Indirect Cost"; Boolean)
        {
            ...
            trigger OnValidate()
            begin
                fnTrackChanges('Change in Indirect Cost', Format(xRec."Indirect Cost"), Format("Indirect Cost"));
            end;
        }
        field(50105; "Allowed Indirect Cost"; Code[20])
        {

            trigger OnValidate()
            begin
                fnTrackChanges('Change in Allowed Indirect Cost ', Format(xRec."Allowed Indirect Cost"), Format("Allowed Indirect Cost"));
            end;
        }
        field(50106; "Consistence with inst. Objs."; Boolean) { }
        field(39003906; "Grant Code"; Code[20])
        {
            ...
            begin
                ...
                DimVal.SETRANGE(DimVal.Code,"Shortcut Dimension 3 Code");
                 IF DimVal.FIND('-') THEN
                    Dim3:=DimVal.Name
                 */
                fnTrackChanges('Change in Department', xRec."Shortcut Dimension 3 Code", "Shortcut Dimension 3 Code");
            ...
            begin
                ...
                DimVal.SETRANGE(DimVal.Code,"Shortcut Dimension 4 Code");
                 IF DimVal.FIND('-') THEN
                    Dim4:=DimVal.Name
                 */
                fnTrackChanges('Change in Department', xRec."Shortcut Dimension 4 Code", "Shortcut Dimension 4 Code");

            end;
        }
        field(39003921; "Payment Methods name"; Text[100])
        {
            CalcFormula = lookup("Payment Method".Description where(Code = field("Payment Methods")));
            FieldClass = FlowField;
        }
        field(39003922; "Obligated Amount"; Decimal)
        {
            Description = 'An alert to be provided when the grant expenditure is 90% of the Obligated Amount';
        }
        field(39003923; "E-Mail"; Text[230]) { }
        field(39003924; "Obligated Amount %"; Decimal)
        {
            Description = 'To carry % of obligated amount usage';
        }
        field(39003925; "Proposal Status"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(39003926; "Member Type"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ',Staff,Student';
            OptionMembers = ,Staff,Student;
        }
        field(39003927; "Member No"; code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = IF ("Member Type" = CONST(Staff)) "HR-Employee"."No."
            ELSE
            IF ("Member Type" = CONST(Student)) Customer."No.";
        }
    }
    ...
    begin
        if Status = Status::"Concept Formulation" then begin
            if "No." = '' then begin
                JobSetup.Get;
                JobSetup.TestField("Concept Nos");
                "No." := NoSeriesMgt.GetNextNo(JobSetup."Concept Nos", 0D, true);
            end;
        end else
            if Status = Status::Proposal then begin
                if "No." = '' then begin
                    JobSetup.Get;
                    JobSetup.TestField("Proposal Nos");
                    "No." := NoSeriesMgt.GetNextNo(JobSetup."Proposal Nos", 0D, true);
                end;
            end else
                if Status = Status::Contract then begin
                    if "No." = '' then begin
                        ...
                        "No." := NoSeriesMgt.GetNextNo(JobSetup."System Contract Nos", 0D, true);
                    end;
                end;
        if Status = Status::QA then begin
            if "No." = '' then begin
                JobSetup.Get;
                JobSetup.TestField("QA Nos");
                "No." := NoSeriesMgt.GetNextNo(JobSetup."QA Nos", 0D, true);
            end;
        end;
        if Status = Status::Research then begin
            if "No." = '' then begin
                JobSetup.Get;
                JobSetup.TestField("Research Nos");
                "No." := NoSeriesMgt.GetNextNo(JobSetup."Research Nos", 0D, true);
            end;
        end;
        if Status = Status::Market then begin
            if "No." = '' then begin
                JobSetup.Get;
                JobSetup.TestField("Marketting Nos");
                "No." := NoSeriesMgt.GetNextNo(JobSetup."Marketting Nos", 0D, true);
            end;
        end;
    ...
    var
        ...
        respCntr: Record "Responsibility Center BR";
    ...
    begin
        ...
        Job."No." := NoSeriesMgt.GetNextNo(JobSetup."Job Nos.", 0D, true);
        // JobSetup.Get;
        // JobSetup.TestField("Job Nos.");
    ...
    begin
        ...
        if Status = Status::"Concept Formulation" then begin
            ...
            if "Proposal No" = '' then begin
                ...
                "Proposal No" := NoSeriesMgt.GetNextNo(JobSetup."Proposal Nos", 0D, true);
            end;
            //+++++++++++++++++++++++++++++++++++++++++++++++++++
            Job.Init;
            ...
            if Status = Status::Proposal then begin
                ...
                if "System Contract No" = '' then begin
                    ...
                    "System Contract No" := NoSeriesMgt.GetNextNo(JobSetup."System Contract Nos", 0D, true);
                end;
                //+++++++++++++++++++++++++++++++++++++++++++++++++++
                ...
                if Status = Status::Contract then begin
                    ...
                    if "Project No" = '' then begin
                        ...
                        "Project No" := NoSeriesMgt.GetNextNo(JobSetup."Job Nos.", 0D, true);
                    end;
                    //+++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    begin
        ...
        DimVal.SetRange(DimVal.Code, mJobs."No.");
        DimVal.SetRange(DimVal."Global Dimension No.", 2);
        if DimVal.Find('-') then begin
            ...
            mJobs."Global Dimension 2 Code" := mJobs."No.";
            mJobs.Modify;
    ...
    procedure CreateResp(mJobs: Record Jobs)
    begin
        //Insert grant in Dim No.
        GLSetup.Get;
        respCntr.Init;
        respCntr.Code := mJobs."No.";
        respCntr.Name := mJobs."Description 2";
        respCntr.Insert;
        Message('Project ID' + ' ' + mJobs."No." + ' ' + 'successfully added to responsibility values'
    + ' ' + GLSetup."Global Dimension 2 Code");
    end;

    procedure InsertToProjectDonors()
    var
        objProjectDonors: Record "Project Donors";
    begin
        objProjectDonors.Reset;
        objProjectDonors.SetRange(objProjectDonors."Shortcut Dimension 1 Code", "Global Dimension 1 Code");
        if objProjectDonors.Find('-') then begin
            objProjectDonors.Init;
            objProjectDonors."Shortcut Dimension 1 Code" := "Global Dimension 1 Code";
            objProjectDonors."Grant No" := "No.";
            objProjectDonors."Donor Name" := "No.";
            objProjectDonors.Insert;
        end;

        // objProjectDonors."Donor Name":=
    end;

    procedure fnTrackChanges(columnss: Code[250]; oldValue: Code[250]; NewValue: Code[250])
    begin
        /*HRtracker.INIT;
        HRtracker."Project No":= "No.";
