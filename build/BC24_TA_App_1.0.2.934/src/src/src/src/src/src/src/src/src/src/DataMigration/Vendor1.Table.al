Table 50021 Vendor1
{
    ...
    fields
    {
        ...
        field(7; City; Text[30])
        {
            ...
            trigger OnValidate()
            begin
                PostCode.ValidateCity(City, "Post Code", Region, "Country/Region Code", (CurrFieldNo <> 0) and GuiAllowed);
            end;
        }
        ...
        field(91; "Post Code"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                PostCode.ValidatePostCode(City, "Post Code", Region, "Country/Region Code", (CurrFieldNo <> 0) and GuiAllowed);
            end;
        }
        field(92; Region; Text[30])
        {
            Caption = 'Region';
        }
    ...
    begin
        if "No." = '' then begin
            ...
            "No." := NoSeriesMgt.GetNextNo(PurchSetup."Vendor Nos.", 0D, true);
        end;
        if "Invoice Disc. Code" = '' then
            "Invoice Disc. Code" := "No.";
