page 50310 "Quality Assuarance Card"
{
    Caption = 'Quality Assuarance Card';
    PageType = Card;
    RefreshOnActivate = true;
    SourceTable = Jobs;
    SourceTableView = WHERE(Status = CONST(QA), "Approval Status" = FILTER(Open | "Pending Approval"));
    ApplicationArea = All;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("No."; Rec."No.")
                {
                    ...
                    ToolTip = 'Specifies the value of the QAC Note ID field.';
                ...
                field(Description; Rec.Description)
                {
                    Caption = 'QAC Title';
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the QAC Title field.';
                }
                ...
                field("Payment Methods"; Rec."Payment Methods")
                {
                    caption = 'QAC Area';
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the QAC Area field.';
                }
    ...
    actions
    {
        area(navigation)
        {
            Group(Objectives)
            {
                action("Obj")
                {
                    Caption = 'QAC Objective';
                    Ellipsis = true;
                    Image = CalculateWIP;
                    RunObject = page "Research Objectives";
                    RunPageLink = No = field("No.");
                    ToolTip = 'Executes the QAC Objective action.';
                }
            }
            group("W&IP")
            {
