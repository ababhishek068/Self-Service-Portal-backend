Page 50547 "Audit Manager RLE Center"
{
    Caption = 'Audit Manager Role Center';
    PageType = RoleCenter;
    ApplicationArea = All;
        ...
        area(sections)
        {
            group(Audits)
            {
                ...
                action(AuditAnnualWorkPlan)
                {
                    ...
                    Image = plan;
                    Promoted = true;
                    RunObject = Page "Int. Audit Work Plans";
                    ToolTip = 'Executes the Audit Annual WorkPlan action.';
                }
                action(AuditProg)
                {
                    ApplicationArea = Basic;
                    Caption = 'Audit Programmes';
                    Image = "List";
                    Promoted = true;
                    RunObject = page "Audit Programme";
                    ToolTip = 'Executes the Audit Programmes action.';
                }
                action(Audit)
                {
                    ApplicationArea = Basic;
                ...
                action(AuditSetup)
                {
                    ...
                    Image = meetings;
                    Promoted = true;
                    RunObject = Page "Int. Audit Setups";
                    ToolTip = 'Executes the Audit Setup action.';
                }
                action(AuditAreas)
                {
                    ApplicationArea = Basic;
                    ...
                    Image = meetings;
                    Promoted = true;
                    RunObject = Page "Int. Audit Areas";
                    ToolTip = 'Executes the Audit Areas action.';
                }
            }
            group(Risk)
            {
