            ...
            group("Address & Contact")
            {
                ...
                group(AddressDetails)
                {
                    ...
                    field("Country/Region Code"; Rec."Country/Region Code")
                    {
                        ...
                        trigger OnValidate()
                        begin
                            IsRegionVisible := FormatAddress.UseCounty(Rec."Country/Region Code");
                        end;
                    }
                    field(City; Rec.City)
                    {
                    ...
                    group(Control10)
                    {
                        ...
                        field(Region; Rec.County)
                        {
                            ApplicationArea = Basic, Suite;
                            ToolTip = 'Specifies the state, province or Region as a part of the address.';
                        }
                    }
        ...
        area(reporting)
        {
            action("CustomStatement")
            {
                ...
                var
                    ...
                    CustStat: report "Customer Statement2";
                begin
                    Cust.reset;
                    Cust.setfilter("No.", Rec."No.");
                    if Cust.find('-') then begin
                        CustStat.SetTableView(Cust);
                        CustStat.Run();
                    end;
                end;
            }
