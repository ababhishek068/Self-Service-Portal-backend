Report 50342 "Customer Statement Local"
{
    DefaultLayout = RDLC;
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Detailed Cust. Ledg. Entry"; "Detailed Cust. Ledg. Entry")
            {
                ...
                begin
                    ...
                    InvHeader.RESET;
                    InvHeader.SetRange(InvHeader."No.", "Detailed Cust. Ledg. Entry"."Document No.");
                    IF InvHeader.Find('-') THEN begin
                        strPosting := InvHeader."Ship-to Contact";
                    ...
                    if sline.find('-') then begin
                        repeat
                            ...
                            Vessel := Sline."Truck No";
                            PriceKES := Sline."Unit Price";
                            Lts := Sline.Quantity;
                            itemRec.Reset;
                            itemRec.SetRange(itemRec."No.", Sline."No.");
                            ...
                            // Description2 := Description2 +' - ' + ProductType + ' - ' + strPosting;
                            Description2 := strPosting + ' - ' + ProductType;
                        until sline.next = 0;
                    end;
                end;
