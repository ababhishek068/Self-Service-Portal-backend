...
page 51586 "Job Achiev to Target Chart"
{
    Caption = 'Job Achievement to Target Chart';
    PageType = CardPart;
    SourceTable = Job;
    ...
    begin
        ...
        JobChartMgt.CreateChart(BusChartBuf, TempJob, NewChartType, Enum::"Job Chart Type"::"Achievement to Target");
