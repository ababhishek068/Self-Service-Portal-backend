Table 50338 "Sectional Strategic Objective"
{
    ...
    fields
    {
        ...
        field(6; "Perfomance Goals and Targets"; Text[200]) { }
        ...
        field(32; Perspective; Code[20])
        {
            ...
            TableRelation = "HR Appraisal Pespectives".Code;

            trigger OnValidate()
            begin
                perspectiveObjective.Reset;
                perspectiveObjective.SetRange(perspectiveObjective.Code, Perspective);
                if perspectiveObjective.Find('-') then
                    "Perspective Description" := perspectiveObjective.Description;
            end;
        }
        field(33; "Perspective Description"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    keys
    {
        ...
        key(Key2; Sections, Perspective) { }
    }

    fieldgroups { }

    var
        perspectiveObjective: Record "HR Appraisal Pespectives";
}
