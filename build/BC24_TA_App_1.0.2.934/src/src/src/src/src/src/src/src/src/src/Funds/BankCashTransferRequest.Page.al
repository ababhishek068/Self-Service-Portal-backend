Page 51428 "Bank & Cash Transfer Request"
{
    DeleteAllowed = false;
    PageType = Card;
    PromotedActionCategories = 'New,Process,Reports,Approvals';
    SourceTable = "InterBank Transfers";
    SourceTableView = where(Posted = filter(false), Type = filter(Interbank));
    ApplicationArea = All;
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field(ExternalDocNo; Rec."External Doc No.")
                {
                    ...
                    ApplicationArea = Basic;
                    Editable = true;
                    //"External Doc No.Editable";                    ToolTip = 'Specifies the value of the Cheque No. field.';
        ...
        area(factboxes)
        {
            part("Attached Documents"; "Document Attachments")
            {
                ...
                SubPageLink = "Table ID" = CONST(50883),
                "No." = FIELD(No);
            ...
            group(Functions)
            {
                ...
                action(Print)
                {
                    ...
                    begin
                        ...
                        Report.Run(50293, true, true, Rec);
                        Rec.Reset;
                    end;
                }
