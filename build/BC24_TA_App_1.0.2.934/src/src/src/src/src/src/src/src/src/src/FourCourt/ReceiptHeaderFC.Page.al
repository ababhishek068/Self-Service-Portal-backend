page 51069 "Receipt Header FC"
{
        ...
        area(content)
        {
            group(Control1)
            {
                ...
                field("Sales Person"; Rec."Sales Person")
                {
                    ...
                    begin
                        if Attend.get(Rec."Sales Person") then begin
                            Attend.TestField("Sales Account No");
                            Rec."Global Dimension 1 Code" := Attend."Global Dimension 1 Code";
                            Rec."Shortcut Dimension 2 Code" := Attend."Global Dimension 2 Code";
                            Rec."Received From" := Attend.Name;
                            Rec."Customer No" := Attend."Sales Account No";
                        end;
                    end;
                }
                ...
                field("Shift Discount"; Rec."Shift Discount")
                {
                    Editable = false;
                    ApplicationArea = all;
                    ToolTip = 'Specifies the value of the Shift Discount field.';
                }
            ...
            {
                Caption = 'Lines';
                part(Control1000000000; "Receipts Line FC")
                {
                    ApplicationArea = all;
        ...
        area(processing)
        {
            action(Print)
            {
                ...
                begin
                    ...
                    //REPORT.Run(70135025, true, true, Rec);
                    REPORT.Run(70135001, true, true, Rec);
                    Rec.Reset;
                end;
            }
            action(Post)
    ...
    begin
        ...
        if IsCashAccount then begin
            CashOffice.get();
            if NOT CashOffice."Receipts Posted Later" then
        ...
        if BAmount < tAmount then begin
            ...
            GenJnlLine."Salespers./Purch. Code" := Rec."Sales Person";
