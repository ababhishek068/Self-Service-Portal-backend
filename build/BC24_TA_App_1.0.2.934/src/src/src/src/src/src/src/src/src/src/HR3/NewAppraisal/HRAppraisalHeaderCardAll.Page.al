Page 51114 "HR Appraisal Header Card - All"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            // part("Perspective Object"; "Sectional Strategic Objective")
            // {
            //     ShowFilter = false;
            ...
            // }
            // part("Targets and Indicator"; "HR Targets Indicator FB")
            // {
            //     Caption = 'Targets and Indicator';
            //     ShowFilter = false;
            //     SubPageLink = "Appraisal No" = field("Appraisal No"),
            //                   "Employee No" = field("Employee No."),
            //                   "Appraisal Period" = field("Appraisal Period");
            //     SubPageView = where("Targets Varied Mid Term" = filter(false));
            // }
            // part(Control6; "HR Training and Competencies")
            // {
            //     ShowFilter = false;
            //     SubPageLink = "Appraisal No" = field("Appraisal No"),
            //                   "Employee No" = field("Employee No."),
            //                   "Appraisal Period" = field("Appraisal Period");
            // }
            // part("Final Evaluation"; "Final Valuation cl.")
            // {
