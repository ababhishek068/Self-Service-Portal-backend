report 50359 "HR Payment Voucher"
{
    DefaultLayout = RDLC;
    RDLCLayout = './NewLayouts/PaymentVoucherhr.rdl';
    ApplicationArea = All;
    dataset
    {
        dataitem("Payment Line"; "Payment Line")
        {
            ...
            begin
                ...
                if PVHeader."Payment Type" = PVHeader."payment type"::Normal then
                    DOCNAME := 'PAYMENT VOUCHER HR SERVICE'
                else
                    DOCNAME := 'PETTY CASH PAYMENT VOUCHER';
                docname2 := PVHeader."Global Dimension 1 Code";
    ...
    var
        ...
        docname2: code[50];
        acconly: label 'For Accounting Use Only';
        Projectname: text[40];
