Table 50319 "Bank Acc. Statement Line1"
{
    ...
    fields
    {
        ...
        field(50006; "Bank GL Count"; Code[100])
        {
            CalcFormula = lookup("Bank Account Ledger Entry"."External Document No." where("External Document No." = field("Document No."),
                                                                                            Open = filter(true)));
            FieldClass = FlowField;
        }
    }
    ...
    begin
        PostExchField.DeleteRelatedRecords("Data Exch. Entry No.", "Data Exch. Line No.");
        ...
        if BankAccReconciliationLine.IsEmpty then
            PostExchField.DeleteRelatedRecords("Data Exch. Entry No.", 0);
    end;
    ...
    var
        ...
        TestDiction: List of [Dictionary of [Integer, Code[20]]];
