Page 51119 "HR Appraisal Lines - CS"
{
    ...
    //SourceTableView = where("Perspective Code" = filter('CUST/STHLD'));
    ApplicationArea = All;
    ...
    begin
        Rec."Perspective Code" := 'CUST/STHLD';
        Rec.Validate("Perspective Code");
    end;

    // trigger OnNewRecord(BelowxRec: Boolean): Boolean
    // begin
    //     "Perspective Code" := 'CUST/STHLD';
    //     Validate("Perspective Code");
    // end;
