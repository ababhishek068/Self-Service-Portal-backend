Page 50717 "Restricted Tendering"
{
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Procuremet Methods"; Rec."Procuremet Methods")
                {
                    ApplicationArea = Basic;
    ...
    var
        ...
        PQH: Record "Purchase Quote Header Request";
        repvend: Report "Purchase Requisition Report";
