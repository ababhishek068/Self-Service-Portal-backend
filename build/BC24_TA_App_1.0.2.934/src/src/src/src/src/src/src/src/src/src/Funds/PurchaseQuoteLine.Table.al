Table 50493 "Purchase Quote Line"
{
    ...
    fields
    {
        ...
        field(5707; "Item Reference Type"; Option)
        {
            Caption = 'Cross-Reference Type';
            OptionCaption = ' ,Customer,Vendor,Bar Code';
            OptionMembers = " ",Customer,Vendor,"Bar Code";
        }
        field(5708; "Item Reference Type No."; Code[30])
        {
        ...
        field(50004; "Request Summary."; Text[50]) { }
        field(39004240; Committed; Boolean) { }
        // field(39004241; "Expense Code"; Code[50])
        // {
        ...
        field(39004243; Specifications; text[500]) { }
        ...
        field(39004247; Remarks; Text[150]) { }
        field(39004353; "Extended Order Description"; Text[150]) { }
        field(39004354; "Requisition No"; code[20]) { }
        field(39004355; "Request Summary"; text[200]) { }
