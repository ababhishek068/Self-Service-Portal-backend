  ...
  router.get(
    ...
    safe(async (req, res) => {
      ...
      const result = await callSoapMethod('GetLeaveDates', {
        ...
        startDate: start,
        // WSDL declares whetherIsHalfDay as Boolean. PHP's SoapClient used to
        // coerce 0/1 automatically; our raw SOAP envelope must do it explicitly.
  ...
  router.post(
    ...
    safe(async (req, res) => {
      ...
      const datesResult = await callSoapMethod('GetLeaveDates', {
        ...
        whetherIsHalfDay: isHalfDaySelection(body.isHalfDayLeave),
      })
      ...
      const result = await callSoapMethod('LeaveApplication', {
        ...
        // BC declares this parameter as Boolean. Sending the portal's numeric
        // option (0/1/2) causes "0 can't be evaluated into type Boolean".
