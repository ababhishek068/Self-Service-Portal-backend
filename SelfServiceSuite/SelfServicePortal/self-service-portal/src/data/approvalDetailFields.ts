...
export const approvalDetailFields: Record<string, DetailFieldConfig[]> = {
  ...
  maintenance: [
    { label: 'Request Type', paths: ['payload.RequestType', 'payload.RequisitionType', 'payload.Requisition_Type', 'payload.Type'] },
    ...
    { label: 'Next Service KM', paths: ['payload.NextServiceKM'] },
  ...
  imprestSurrender: [
    ...
    },
    {
      ...
      paths: ['payload.Balance', 'payload.BalanceLessThisEntry', 'payload.OutstandingBalance'],
      format: 'currency',
    },
    {
      label: 'Rejection Reason',
