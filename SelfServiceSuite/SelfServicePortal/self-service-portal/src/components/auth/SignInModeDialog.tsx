...
export function SignInModeDialog({ open, onClose, onSelect, disabled }: SignInModeDialogProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-start justify-between gap-3 border-b border-slate-100 bg-gradient-to-r from-[var(--portal-navy)] to-[var(--portal-green)] px-5 py-4 text-white">
          <div>
